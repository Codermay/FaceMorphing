...
\******************************************************************************/
#ifndef _GL_MATHS_FUNCS_H_
#define _GL_MATHS_FUNCS_H_
...
// camera functions
mat4 GLM_look_at(const vec3& cam_pos, vec3 targ_pos, const vec3& up);
mat4 GLM_perspective(float fovy, float aspect, float near, float far);
